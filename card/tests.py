...
class TestCard(TestBase):
    ...
    def testCreation(self):
        ...
        card = self.card_object.addNew(self.customer['user'], delivery=delivery1, receive_time=datetime.datetime.now(),
                                       address_good=address1, address_invoice=address2, discount=discount1,additional_option=option)
        ...
        # print(order2.order_price)
        # print(order3.order_price)
        print(card.total_cost)